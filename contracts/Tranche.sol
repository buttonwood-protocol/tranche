 ...
 */
contract Tranche is ITranche, ERC20, Initializable, Clone {
     ...
     * @param _bond The bond owner of this ERC20 token
     */
    function init(
        string memory name,
        ...
        require(collateralToken() != address(0), "Tranche: invalid collateralToken address");
